<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewTeacherSalaryDetail.aspx.cs" Inherits="USTA.WebApplication.Common.WebForm1" %>
...
<body>
    ...
    <div>
        <table width="100%" class="tableAddStyleNone">
            ...
            <tr><th width="30%"></th>酬金项<th width="50%">详情</th><th width="20%">总额</th></tr>
            </table>
            </HeaderTemplate>
                <ItemTemplate>
                <table class="datagrid2">
