...
{
    public partial class ViewProjectManagerAuth : CheckUserWithCommonPageBase
    {
        ...
        protected void dsltAuthTeacher_OnItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("remove"))
            {
                ...
                Javascript.JavaScriptLocationHref("/Administrator/ViewProjectManagerAuth.aspx", Page);
            }
        }
    }
}