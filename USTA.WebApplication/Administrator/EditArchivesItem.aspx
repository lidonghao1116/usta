<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditArchivesItem.aspx.cs" Inherits="USTA.WebApplication.Administrator.EditArchivesItem" %>
    ...
    <table width="100%" class="tableAddStyleNone">
     <tr>
        ...
        <tr>
            ...
            <td class="border">
                <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" Rows="10" CssClass="required" Width="600px">
                </asp:TextBox>
            </td>
        </tr>
        <tr>
