<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSecondNotifyType.aspx.cs" Inherits="USTA.WebApplication.Administrator.AddSecondNotifyType" %>
...
<body>
    ...
    <table width="100%" class="tableAddStyleNone"><tr>
            <td class="border">
                        请选择文章二级分类：
                        </td>
            <td class="border"><asp:DropDownList ID="ddlNotifyTypeManage" runat="server">
                        </asp:DropDownList> </td>
        </tr>
            <tr>
            <td class="border">
