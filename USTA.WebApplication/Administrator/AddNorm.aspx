<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNorm.aspx.cs" Inherits="USTA.WebApplication.Administrator.AddNorm" %>
     ...
     <tr><td class="border">指标类型</td><td class="border">
        ...
        <tr><td class="border">指标名称</td><td class="border">
         ...
         <tr><td class="border">备注</td><td class="border">
             <asp:TextBox ID="TextComment" runat="server" TextMode="MultiLine" Width="80%"></asp:TextBox>
            </td></tr>
            <tr><td class="border"></td><td class="border">
