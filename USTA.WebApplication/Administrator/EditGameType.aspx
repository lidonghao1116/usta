<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGameType.aspx.cs" Inherits="USTA.WebApplication.Administrator.EditGameType" %>
    ...
    <table class="tableAddStyle" width="100%">
        ...
        <tr>
            ...
            <td>
                ...
                CssClass="required number" Text="4"></asp:TextBox><asp:HiddenField ID="hidGroupCapability" runat="server" Value="" />
                    </td>
                </tr>
        <tr>
            <td width="15%">
