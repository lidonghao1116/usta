...
{
    public partial class WebForm2 : CheckUserWithCommonPageBase
    {
        ...
        protected void SelectSalaryItem_SelectCourse(object sender, EventArgs e)
        {
            ...
            Javascript.JavaScriptLocationHref("/Administrator/SelectSalaryItem.aspx?teacherNo=" + teacherNo + "&courseNo=" + courseNo, Page);
        ...
        protected void AddSalary_Forwad(object sender, EventArgs e) 
        {
            ...
            string outSalaryItemIds = GetSelectedOutSalaryItemIds();
            string teacherNo = this.teacherNo.Value;
            string courseNo = this.SelectCourse.SelectedValue;
            ...
            {
                Javascript.AlertAndRedirect("请至少指定一项待发薪酬项", "/Administrator/SelectSalaryItem.aspx?teacherNo=" + teacherNo, Page);
            }

            Javascript.JavaScriptLocationHref("/Administrator/AddSalaryEntry.aspx?tid=" + teacherNo + "&inIds=" + inSalaryItemIds + "&outIds=" + outSalaryItemIds + "&cid=" + courseNo + "&acType=" + atCourseType + "&teacherType=" + teacherType, Page);
        }
        ...
        /// <summary>
        /// private 方法，获得选中的薪酬扣除项id列表字符串
        /// </summary>
        /// <returns></returns>
        private string GetSelectedOutSalaryItemIds() {

            List<string> selectedOutSalaryItemList = GetSelectedSalaryItemIdList(this.TeacherOutSalaryItemList.Items, "salaryItemOutChkBox", "salaryItemOutId");

            return ConvertSalaryItemIdList2String(selectedOutSalaryItemList);
        }
