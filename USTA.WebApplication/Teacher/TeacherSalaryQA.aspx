<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherSalaryQA.aspx.cs" Inherits="USTA.WebApplication.Teacher.TeacherSalaryQA" %>
...
<body>
    ...
    <div>
        <asp:DataList Width="80%" ID="TeacherSalaryQAList" runat="server" DataKeyField="salaryQaId">
        
            <HeaderTemplate>
            <% if (this.TeacherSalaryQAList.Items.Count > 0)
               { %>
        ...
        <table width="80%" class="tableAddStyleNone">
            <tr>
                ...
                <td width="80%" class="border">
                     <asp:TextBox ID="newTeacherSalaryQA" Rows="3" Columns="40" MaxLength="500" TextMode="MultiLine" runat="server" CssClass="required" ></asp:TextBox>
