<%@ Page Language="C#" AutoEventWireup="true" Inherits="Teacher_VSWorkNOnlineWorkUnSubed" 
    MasterPageFile="~/MasterPage/ViewSchoolworkNotify.master" Codebehind="VSWorkNOnlineWorkUnSubed.aspx.cs" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="CouserInfoContent" runat="server">
     <div class="ui-tabs-panel">
        ...
        <asp:DataList ID="dlSchoolWork" runat="server" DataKeyField="studentNo"  Width="100%">
             <HeaderTemplate>
            ...
            </ItemTemplate><FooterTemplate><%=(this.dlSchoolWork.Items.Count == 0 ? "未找到数据" : null)%></FooterTemplate><FooterStyle CssClass="datalistNoLine" />          
        </asp:DataList>
