<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/BBSindex.master" AutoEventWireup="true" Inherits="bbs_BBSSpecialindex" EnableViewState="false"  Codebehind="BBSSpecialindex.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BBSContent" runat="Server">
    <div class="ui-tabs-panel">
        <asp:DataList ID="dlstpic" runat="server" RepeatDirection="Horizontal" RepeatColumns="4"
            ...
            <ItemTemplate>
                <table style="color: #666666;">
                    <tr>
                        ...
                        <td>
                            <a href="BBSTopicList.aspx?tag=2&forumId=<%#Eval("forumId") %>">
            ...
            <FooterTemplate>
                <%=(this.dlstpic.Items.Count == 0 ? "对不起，未找到数据" : null)%></FooterTemplate>
